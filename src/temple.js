...
import Image1 from './assets/images/temple1.jpg';
import Image2 from './assets/images/temple2.jpg';
import Image3 from './assets/images/temple3.jpg';
            ...
            <div className="row">
              <div className="col-lg-8 offset-lg-2">
                <div className="header-text">
                  <h2><em>Temple</em> Interior Design</h2>
